...
patch = `v${majorFromConfig}.${minorFromConfig}.10` === version ? patch += 1 : 0;

const newVersion = `v${majorFromConfig}.${minorFromConfig}.${patch}`;

// eslint-disable-next-line max-len
execSync(`git add . && git commit -m "updated gitpush script test version 10" && git push origin master`, { stdio:[0, 1, 2] });
